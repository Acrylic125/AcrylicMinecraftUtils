...
public class NormalItemTypeRegistry {
    ...
    public static void register() {
        ...
        NormalItemTypeManager.cache(NormalItemType.CHESTPLATE,
                Material.LEATHER_CHESTPLATE, Material.GOLDEN_CHESTPLATE, Material.CHAINMAIL_CHESTPLATE, Material.IRON_CHESTPLATE, Material.DIAMOND_CHESTPLATE, Material.NETHERITE_CHESTPLATE,Material.ELYTRA);
